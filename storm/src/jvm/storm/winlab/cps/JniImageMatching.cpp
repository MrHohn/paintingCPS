...
JNIEXPORT void JNICALL Java_storm_winlab_cps_JniImageMatching_initiate_1imageMatching( JNIEnv *env, jclass cls, jstring indexImgTable_addr, jstring imgIndex_yml_addr, jstring info_database_addr ){
    ...
    ImgMatch::init_matchImg(indexImgTableAddr,imgIndexYmlAddr,infoDbAddr);
...
JNIEXPORT jstring JNICALL Java_storm_winlab_cps_JniImageMatching_matchingIndex (JNIEnv *env, jclass cla, jbyteArray img, jint size)
{
    char *cImg;
    jboolean jb;
